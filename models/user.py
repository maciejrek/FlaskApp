...
class UserModel(db.Model):
    ...
    # lazy="dynamic": confirmation can be created after creating user model,
    # and can be accessed after creation of confirmation model
    # (otherwise it'll be none)
    # cascade: delete confirmations related to user, on user delete
